...
function t_cover__initCovers() {
  ...
  (e && 'edit' === e.getAttribute('data-tilda-mode')) ||
    Array.from(document.querySelectorAll('.t-cover__carrier')).forEach(
      function (e) {
...
function t_cover__recalcCoverHeight(e, t) {
  ...
  if (o) {
    var r = o.querySelector('.t-cover'),
      n =
        o.getAttribute('data-parenttplid') ||
        o.getAttribute('data-record-type');
    if (r && '935' !== n) {
...
function t_cover__getHeightFromAttr(e) {
  return e
    ? -1 !== e.indexOf('vh')
      ? (parseInt(e, 10) * document.documentElement.clientHeight) / 100
      : parseInt(e, 10)
    : 0;
}
    ...
    g.forEach(function (t) {
      ...
      Array.prototype.slice.call(e.querySelectorAll(t)).forEach(function (e) {
        ...
        l < document.documentElement.clientHeight
          ? ((s = 0.2 * document.documentElement.clientHeight),
            (e.style.height = l + s + 'px'))
          : e && (e.style.height = l + 'px');
      });
    }),
...
function t_cover__getRecordType(e) {
  ...
  return (
    (e &&
      (e.getAttribute('data-parenttplid') ||
        e.getAttribute('data-record-type') ||
        (null == (t = e.closest('.record'))
          ? void 0
          : t.getAttribute('data-parenttplid')) ||
        (null == (o = e.closest('.record'))
          ? void 0
          : o.getAttribute('data-record-type')))) ||
    ''
  );
