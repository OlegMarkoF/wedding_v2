(window.Tilda = window.Tilda || {}),
  (function () {
    function e() {
      ...
      function c(e) {
        ...
        if (e.target && t) {
          ...
          if (!i)
            i =
              '/tilda/click/' + (r ? r.getAttribute('id') : '') + '/?url=' + c;
          if (
            (Tilda.sendEventToStatistics(i, o),
            'http' === c.substring(0, 4) && -1 === c.indexOf('.typeform.com/'))
          )
            return (
              window.setTimeout(
                function () {
    ...
    (Tilda.sendEcommerceEvent = function (e, t) {
      ...
      if (
        void 0 === e ||
        ('add' !== e && 'remove' !== e && 'purchase' !== e && 'detail' !== e)
      )
        return !1;
      for (
        var r, a = '', i = 0, o = [], c, d, n = '', m = '', l = '', u = 0;
        u < t.length;
        u++
      ) {
        a > '' && (a += ', '),
          ...
          if (
            ...
            (r = {
              ...
              window.tildaForm.tildapayment &&
                ...
                (r.ecommerce.purchase.actionField.coupon =
                  window.tildaForm.tildapayment.promocode),
              (r.event = 'purchase');
          else if (
            r &&
            ...
            for (var s = 0; s < o.length; s++)
              o[s].id ||
                (o[s].uid
                  ...
                  : o[s].recid &&
                    o[s].lid &&
                    (o[s].id = o[s].recid + '_' + o[s].lid));
            r.ecommerce.add && r.ecommerce.add.products
              ? ((r.ecommerce.add.products = o), (r.event = 'addToCart'))
              : r.ecommerce.remove && r.ecommerce.remove.products
              ? ((r.ecommerce.remove.products = o),
                (r.event = 'removeFromCart'))
          ...
          if (window.gtagTrackerID && 'gtag' === window.mainTracker)
            if (i)
              if (r && r.event)
                if ('purchase' === r.event) {
                  for (
                    var o = r.ecommerce.purchase.products, w = 0, g = 0;
                    g < o.length;
                    g++
                  )
                    if ('delivery' === o[g].id) {
            ...
            if (r && r.event) {
              try {
                if (
                  ...
                  for (
                    var f, y = r.ecommerce.purchase.products.length, g = 0;
                    g < y;
                    g++
                  )
                  ...
                  for (
                    var f, y = r.ecommerce.add.products.length, g = 0;
                    g < y;
                    g++
                  )
                  ...
                  for (
                    var f, y = r.ecommerce.remove.products.length, g = 0;
                    g < y;
                    g++
                  )
                  ...
                  for (
                    var f, y = r.ecommerce.detail.products.length, g = 0;
                    g < y;
                    g++
                  )
          ...
          try {
            if (i)
              if (
                -1 === e.indexOf('tilda/') ||
                (-1 === e.indexOf('/payment/') &&
                  -1 === e.indexOf('/submitted/'))
              )
                if (r && r.event && a > 0)
                  if ('addToCart' === r.event && r.ecommerce.add) {
                    for (
                      var f, y = r.ecommerce.add.products.length, k = [], g = 0;
                      g < y;
                      g++
                    )
                      (f = r.ecommerce.add.products[g]),
                    ...
                    for (
                      var f,
                        y = r.ecommerce.detail.products.length,
                        k = [],
                        g = 0;
                      g < y;
                      g++
            ...
            if (i) {
              ...
              if (r && r.event)
                if (
                  ...
                  if (a > 0 && b > 0) {
                    ...
                    A.currency_code = u;
                    for (
                      var y = r.ecommerce.purchase.products.length,
                        k = [],
                        g = 0;
                      g < y;
                      g++
                  ...
                  if (a > 0 && b > 0) {
                    ...
                    A.currency_code = u;
                    for (
                      var y = r.ecommerce.add.products.length, k = [], g = 0;
                      g < y;
                      g++
                    )
                      (f = r.ecommerce.add.products[g]),
                  ...
                  if (a > 0 && b > 0) {
                    ...
                    A.currency_code = u;
                    for (
                      var y = r.ecommerce.detail.products.length, k = [], g = 0;
                      g < y;
                      g++
                    )
                      (f = r.ecommerce.detail.products[g]),
                  ...
                  if (a > 0 && b > 0) {
                    ...
                    A.currency_code = u;
                    for (
                      var y = r.ecommerce.remove.products.length, k = [], g = 0;
                      g < y;
                      g++
                    )
                      (f = r.ecommerce.remove.products[g]),
              ...
              b > 0 && A && A.currency_code
                ? (VK.Retargeting.Event('purchase'),
                  VK.Retargeting.ProductEvent(b, T, A))
        ...
        try {
          ...
          if (
            ...
            var a,
              i = t.split('&');
            for (var o in i)
              'amp;' === (a = i[o].split('='))[0].substring(0, 4) &&
                (a[0] = a[0].substring(4)),
