...
function t_forms__initForms() {
  var t = document.querySelectorAll(
    '.r:not([data-record-type="1093"], [data-parenttplid="1093"])'
  );
...
(window.t_forms__lang = (
  ...
  (window.tildaForm.validate = function (t) {
        ...
        if ((((v.length && !E) || (E && A)) && (n = !1), u && (b || (E && !A))))
          ...
          switch (d) {
            ...
            case 'url':
              if (
                ((m =
                  /^((https?|ftp):\/\/)?[a-zA-Zёа-яЁА-ЯЁёäöüÄÖÜßèéûşç0-9xn\-][a-zA-Zёа-яЁА-ЯЁёäöüÄÖÜßèéûşç0-9_\.\-]{0,253}\.[a-zA-Zёа-яЁА-Я\-0-9]{2,11}\/?$/gi),
                v.length)
              )
                if (
                  (f = (f =
                  ...
                  if (!(f = f[0]).match(m)) {
                    var L =
                      /^[a-zA-Zёа-яЁА-ЯЁёäöüÄÖÜßèéûşç0-9]([a-zA-Zёа-яЁА-ЯЁёäöüÄÖÜßèéûşç0-9_\-]|xn--)*(\.[a-zA-Zёа-яЁА-ЯЁёäöüÄÖÜßèéûşç0-9\-]{2,})+$/i;
                    f.match(L) || w.type.push('url');
                  }
                } else (f && !f[0]) || w.type.push('url');
              break;
            case 'phone':
    ...
    if ('y' === a) {
      var M = window.tcart_minorder > 0,
        P = window.tcart_mincntorder > 0,
        q;
      if (M)
        if (
          (q =
            window.tcart.prodamount_withdiscount > 0
              ...
              : void 0 !== window.tcart.prodamount_withdiscount &&
                window.tcart.promocode &&
                'OK' === window.tcart.promocode.message
              ? window.tcart.prodamount_withdiscount
              : window.tcart.prodamount) < window.tcart_minorder
        ) {
          var R = { obj: {}, type: [] };
          R.type.push('minorder'), o.push(R);
        }
      if (P && window.tcart.total < window.tcart_mincntorder) {
        var B = { obj: {}, type: [] };
        B.type.push('minquantity'), o.push(B);
      }
    }
    return (
      n &&
...
function t_forms__onSuccess(t) {
  ...
  var e = t_forms__getElement(t),
    r = e.closest('.r'),
    o =
      r.getAttribute('data-parenttplid') || r.getAttribute('data-record-type'),
...
function t_forms__processFormsInPopup(t, e) {
  ...
  var n = e.closest('.t-rec'),
    a =
      n.getAttribute('data-parenttplid') || n.getAttribute('data-record-type'),
    i;
  '121' === a &&
    (a =
