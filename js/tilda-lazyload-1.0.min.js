function t_lazyload__init() {
  ...
  for (
    var t = document.querySelectorAll('.t156 .t-img'), i = 0;
    i < t.length;
    i++
  )
...
function t_lazyload__onWindowResize() {
  if ((t_lazyload_update(), 'yes' !== window.lazy_imgoptimoff)) {
    var e = document.querySelectorAll(
      '.t-cover__carrier, .t-bgimg, .t-img, .tn-atom__img'
    );
...
function t_lazyLoad__appendImgStatToArr(e, t) {
  if (void 0 !== navigator.sendBeacon) {
    ...
    if (n) {
      var o = { time: i - t };
      0 === n.indexOf('https://' + t_lazyload__getThumbDomainName()) &&
        (o.th = 'y'),
...
function t_lazyload__ping(e) {
  ...
  if ('static' == e) {
    ...
    if (
      ...
      return;
    if (null === document.head.querySelector('script[src^="' + t + '"]'))
      return;
  }
  var n = new Image();
  (n.src = t + '/pixel.png'),
...
function t_lazyload__getBackgroundStyles(e) {
  ...
  if (n) {
    ...
    return (
      s[l] && (l = s[l]),
      c[d] && (d = c[d]),
      { positionX: l, positionY: d, size: o, attachment: a }
    );
  }
  ...
  (function (e, t) {
        ...
        t.forEach(function (e) {
          ...
          y(t) &&
            (e.isNotUnderScreenRange =
              !1 === t.hasAttribute('data-screen-max') &&
              !1 === t.hasAttribute('data-screen-min'));
        }),
        t
      );
    }
    ...
    function b(e) {
      return e.replace(r, function (e, t) {
        return (
          '/' + t_lazyload__getThumbDomainName() + '.' + (l[t] || 'com') + '/'
        );
      });
    }
    function v(e, t, i, a) {
      ...
      if (l) {
        var s = t.clientWidth,
          ...
          u;
        if (
          (g(t, 't-slds__bgimg') || g(t, 't-slds__img')) &&
          !g(t, 't827__image')
        ) {
          var _ = p(t, 't-slds__wrapper');
          _ || (_ = p(t, 't-slds__container')),
            !1 === y(_) && (_ = p(t, 't-slds__thumbsbullet')),
            y(_) && ((s = _.clientWidth), (c = _.clientHeight));
        }
        ...
        if (
          ...
          !0 === E &&
            (l =
              ...
              ('IMG' != t.tagName && 0 == c)
                ? k(l)
                : O(t.tagName, I, l, s, c, b, v)),
          'y' === window.lazy_err_static &&
            h(l) &&
            (l = l.replace(r, '/static3.tildacdn.com/')),
          l)
        ) {
          if ('IMG' === e.tagName) e.setAttribute('src', l);
            ...
            W
              ...
              : ((e.style.backgroundImage = 'url(' + l + ')'), z(e, l));
          }
    ...
    function O(e, t, i, n, o, a, r) {
      ...
      var d = 1;
      1 === window.devicePixelRatio && Math.max(n, o) <= 400 && (d = 1.2),
        window.devicePixelRatio > 1 && (d = 2);
      var s = n,
        c = o,
        u,
        _;
    ...
    function I(e, t, i) {
      if ('string' == typeof t && null != t && '' != t) {
        var n;
        if ((console.error('lazy loading err'), h(t)))
          return (
            (window.lazy_err_static = 'y'),
            void L(e, t.replace(r, '/static3.tildacdn.com/'))
          );
        if (
          -1 !== t.indexOf(t_lazyload__getThumbDomainName()) &&
          -1 !== t.indexOf('/-/')
        ) {
          ...
          if ('' !== a && '' !== l)
            L(
              e,
              'https://static3.tildacdn.com/' +
                a +
                '/' +
                (l = l.replace(/(\.(jpe?g|png|gif|svg))\.webp$/i, '$1'))
            );
          if ('function' != typeof t_errors__sendCDNErrors) {
            var u = document.createElement('script');
            (u.src =
              'https://static.tildacdn.' +
              t_lazyload__getRootZone() +
              '/js/tilda-errors-1.0.min.js'),
    ...
    return (
      (window.t_lazyload_setSources = v),
      (S.prototype._showOnLoad = function (e) {
        var t,
          i = this._settings,
          n;
        function o() {
          null !== i &&
            ...
            v(e, e, i.data_srcset, i.data_src),
        ...
        !e.getAttribute('src') &&
          i.placeholder &&
          e.setAttribute('src', i.placeholder),
          (t = document.createElement('img')).addEventListener('load', o),
          t.addEventListener('error', function (t) {
            m(e, i.class_loading),
              i.callback_error && i.callback_error(e),
              void 0 !== t.path
                ? I(e, t.path[0].currentSrc, n)
                : void 0 !== t.target && I(e, t.target.currentSrc, n);
          }),
          f(e, i.class_loading),
          (n = c()),
          v(t, e, i.data_srcset, i.data_src);
      }),
      (S.prototype._showOnAppear = function (e) {
        ...
        ('IMG' !== e.tagName && 'IFRAME' !== e.tagName) ||
          ...
          e.addEventListener('error', function (o) {
            e.removeEventListener('load', n),
              ...
              void 0 !== o.path
                ? I(e, o.path[0].currentSrc, i)
                : void 0 !== o.target && I(e, o.target.currentSrc, i);
          }),
          f(e, t.class_loading)),
          (i = c()),
          v(e, e, t.data_srcset, t.data_src),
          t.callback_set && t.callback_set(e);
      }),
      (S.prototype._show = function (e) {
        this._settings.show_while_loading
          ? this._showOnAppear(e)
          : this._showOnLoad(e);
      }),
      (S.prototype._initializeObserver = function () {
        var e = this;
        this._intersectionObserver = new IntersectionObserver(
          function (t) {
            ...
            t.forEach(function (t) {
              var n = t.target;
              if (
                !(e._settings.skip_invisible && x(n) && n.isNotUnderScreenRange)
              ) {
                var o = t.boundingClientRect.top + i < 0,
                  ...
                  s =
                    t.intersectionRatio >=
                    Number(
                      n.getAttribute('data-intersection-aspect-ratio') || 0
                    );
                if (n.wasProcessed)
                  return (
                ...
                ((t.isIntersecting && s) || o || r || d) &&
                  (e._show(n), (n.wasProcessed = !0));
              }
            });
          },
      ...
      (S.prototype.loadAnimatedImages = function () {
        var e,
          t,
          i = this._settings,
          n = this._elements,
          ...
          if (g((t = n[e]), 'tn-atom__img') || g(t, 'tn-atom')) {
            ...
            ('intoview' !== s && 'blockintoview' !== s) || (u = 'viewport'),
              ...
              (i.skip_invisible && null === t.offsetParent) ||
                !d ||
                (r(l, u) &&
                  (i.show_while_loading
                    ? this._showOnAppear(t)
                    : this._showOnLoad(t),
                  (t.wasProcessed = !0),
