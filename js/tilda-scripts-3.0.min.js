...
function t_onFuncLoad(t, e, n) {
  ...
  if (a(t) && r()) e();
    ...
    setTimeout(function i() {
      ...
      a(t) && r()
        ? e()
        : ('complete' === document.readyState && d - l > o && !a(t) && s(),
          setTimeout(i, n || 100));
    });
  }
}
        ...
        if (
          ...
          if ('fixed' === r || 'absolute' === r) {
            ...
            a.indexOf('ms') + 1
              ...
              : a.indexOf('s') + 1 &&
                ((a = 1e3 * parseFloat(a.replace('s', ''))), o.push(a));
...
function t_modifyRootZone(t) {
  return t && t.includes('static.tildacdn.com')
    ? t.replace('static.tildacdn.com', 'static.tildacdn.' + t_getRootZone())
    : t;
}
  ...
  if (document.querySelector('script[src^="' + r + '"]')) e && e();
    ...
    (a.type = 'text/javascript'),
      ...
      a.addEventListener('error', function (t) {
        ...
        setTimeout(function () {
          a.remove(),
            t_loadJsFile(r, e, n + 1),
            console.warn('Retrying to load ' + r + '. Retry: ' + (n + 1));
        }, n * i);
      }),
...
function t_loadCSSFile(t, e, n) {
  ...
  if (document.querySelector('link[href^="' + r + '"]')) e && e();
    ...
    (a.rel = 'stylesheet'),
      ...
      e && a.addEventListener('load', e),
      a.addEventListener('error', function (t) {
        if (!(n <= 3)) {
          var o = t.message || '<no error message>';
          throw new Error('Failed to load ' + r + ' style: ' + o, { cause: t });
        }
        setTimeout(function () {
          a.remove(),
            t_loadCSSFile(r, e, n + 1),
            console.warn('Retrying to load ' + r + '. Retry: ' + (n + 1));
        }, n * i);
      }),
      document.head.appendChild(a);
...
function t_scrollTo(t, e) {
  if (t) {
    var n = e || {},
      ...
      d = void 0 === l ? 0 : l,
      s = Math.max(
        parseInt(t.getBoundingClientRect().top + window.scrollY - d, 10),
        0
      );
    o || 'instant' === a
      ? window.scrollTo({ left: 0, top: s, behavior: a })
  ...
  t_onReady(function () {
    ...
    if (
      ...
      for (
        ...
        t_addClass(o, a > 1e3 && a > l ? 'r_hidden' : 'r_showed'),
          t_addClass(o, 'r_anim');
      }
      if (r.length) {
        function d() {
        ...
        var s = document.querySelectorAll(
          '[data-record-type="400"], [data-parenttplid="400"]'
        );
        if (s.length > 0)
          var c = 0,
            u = 0,
    ...
    var w = document.querySelector('.t-tildalabel'),
      f;
      (f = h
      ? Math.max(h.scrollHeight, h.offsetHeight, h.clientHeight, p.offsetHeight)
      : p.offsetHeight) +
      70 <
    window.innerHeight
      ...
      for (
        ...
        if (i) {
          ...
          if (document.documentElement.clientWidth > t)
            (a = (a = i.replace('lineheight', 'line-height')).replace(
              'fontsize',
              'font-size'
            )),
            ...
            if (parseInt(getComputedStyle(o).fontSize.replace('px', '')) < 26)
              continue;
    ...
    setTimeout(function () {
      for (
        ...
        '' === o
          ...
          : -1 === o.indexOf('noopener') &&
            n.setAttribute('rel', o + ' noopener');
      }
    }, 2500);
  }),
  (function (t, e) {
