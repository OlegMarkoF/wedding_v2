...
function t396_init(t) {
  ...
  if (r) {
          ...
          t.forEach(function (t) {
            ...
            'childList' === t.type &&
              Array.from(t.addedNodes)
                .concat(Array.from(t.removedNodes))
                .some(function (t) {
                  return (
                    3 !== t.nodeType &&
    ...
    (a.classList.contains('t235__beforeready') ||
      (e && e.closest('#allrecordstable')) ||
      a.querySelector('[data-record-type="263"]')) &&
      i &&
      r &&
      i.addEventListener('displayChanged', function () {
        t396_allelems__renderView(r),
...
function t396__revalidateDimensions() {
  var t,
    ...
    r;
  return (
    t396__updateWindowDimensions(), e !== t396__getWindowDimensions().width
  );
}
...
function t396__onResize() {
  t396_waitForFinalEvent(
    function () {
      var t;
      t396__revalidateDimensions() &&
        (t396__getZeroBlocks().forEach(function (t) {
          var e = t.record;
          if (e && t396_isBlockVisible(e))
            try {
...
function t396__updateAutoHeight(t) {
  ...
  if ('hug' === t.getAttribute('data-artboard-heightmode')) {
    ...
    if (!(Math.abs(r - o) <= 0.7)) {
      var n,
        a = 'ab' + t.getAttribute('data-artboard-recid'),
        l = window.tn[a].curResolution,
        d;
      l === window.tn[a].curResolution_max
        ? t.setAttribute('data-artboard-height', r)
        : t.setAttribute('data-artboard-height-res-' + l, r),
        t396_ab__renderView(t),
        null == (e = t.closest('.t396')) ||
          e.dispatchEvent(new CustomEvent('zero:height-changed'));
    }
  }
}
function t396__getAutoHeight(t) {
  ...
  if (t396__autoHeight__canAutocalculateHeight(t, r) && o) {
    ...
    e = r.reduce(function (e, r) {
      ...
      var l = 0;
      if (
        ('gallery' === r.getAttribute('data-elem-type') &&
          (l = t396__autoHeight__getAdditionalOffsetForGallery(r)),
        i)
      ) {
...
function t396__autoHeight__canAutocalculateHeight(t, e) {
  ...
  if (
    ...
    var o = t396_ab__getFieldValue(t, 'flexdirection'),
      ...
      l;
    return (
      ('row' === o && 'flex-end' === n) || ('column' === o && 'flex-end' === a)
    );
  }
  return !0;
}
...
function t396_artboard_build(t, e) {
  ...
  if (r) {
    ...
    if (
      (['visible', 'visibleX'].includes(n) &&
        (t396__setOverflowToAllRecords(),
        document.body.addEventListener('tStoreGalleryInitialized', function () {
          t396__setOverflowToAllRecords();
        })),
      'auto' === n)
    ) {
      ...
      switch (e) {
        ...
        case 'width':
          ...
          var u = t396_elem__getFieldValue(i, 'widthmode'),
            c;
          if (
            ((c = t396_elem__getFieldValue(i, 'textfit')) ||
              ('button' === d
                ? (c = 'fixedsize')
                : 'text' === d && (c = 'autoheight')),
            ('text' === d || 'button' === d) && 'autowidth' === c)
          )
          ...
          if (
            ((c = t396_elem__getFieldValue(i, 'textfit')) ||
              ('button' === d
                ...
                : 'text' === d && (c = 'autoheight')),
            ('text' === d || 'button' === d) &&
              ['autowidth', 'autoheight', 'singleline'].includes(c))
          )
            return void (i.style.height = 'auto');
          if (_.includes(g) && 'tooltip' !== d)
...
function t396_elem__setGallerySize(t, e, i) {
  ...
  a =
    'width' === e || 'height' === e
      ? t396__zoomifyValue(t, a, { round: !0 })
...
function t396_elem__convertPosition__Local__toAbsolute(t, e, i) {
  ...
  switch (e) {
    case 'left':
      var I,
        L = t396__getWindowDimensions().width,
        B;
      if (
        ((F = 'grid' === h ? 'grid' : 'window'),
        (A = 'grid' === h ? window.tn[a].grid_offset_left : 0),
        (V = 'grid' === h ? window.tn[a].grid_width : L),
    ...
    case 'top':
      var R = r.closest('.t396__artboard'),
        T = R ? R.getAttribute('data-artboard-proxy-min-offset-top') : '0',
...
function t396_elem__getHeight(t, e) {
  ...
  if (
    (n ||
      ('button' === o ? (n = 'fixedsize') : 'text' === o && (n = 'autoheight')),
    'shape' === o ||
      'video' === o ||
      'html' === o ||
      'gallery' === o ||
      (('text' === o || 'button' === o) && 'fixedsize' === n))
  ) {
    var l;
...
function t396__zoomifyValue(t, e, i) {
  void 0 === i && (i = {});
  var r,
    o = e + (String(e).endsWith('px') ? '' : 'px'),
    n;
  if (t396__isInsideGroupWithZoom(t)) return o;
  var a =
    window.CSS &&
    window.CSS.supports &&
    CSS.supports('width', 'round(10px, 1px)');
  return i.round && a
    ? 'round(' + o + ' * var(--zoom, 1), 1px)'
    : 'calc(' + o + ' * var(--zoom, 1))';
}
