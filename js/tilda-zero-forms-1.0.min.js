function t396__parseGlobalStyleCSSVar(t) {
  try {
    ...
    return {
      parent: { id: s, type: i },
      fallback: window.getComputedStyle(document.body).getPropertyValue(n) || l,
      field: a,
    };
  } catch (c) {
...
function t396__hex2rgba(t, e) {
  if (!t) return !1;
  var r = t396__parseGlobalStyleCSSVar(t);
  r && (t = r.fallback);
  var o = t.replace(/#/, '');
  if (3 === o.length) {
    var n = o[0],
...
function t396__isElementUsingCalcZoom(t) {
  var e = ['gallery'],
    r = t.getAttribute('data-elem-type');
  return e.includes(r);
}
function t396__isFlex(t) {
  var e = t.classList.contains('t396__artboard-flex'),
    r = t.classList.contains('t396__group-flex');
  return e || r;
}
function t396__setOverflowToAllRecords() {
  ...
  if (t) {
    ...
    var r = Boolean(document.querySelector(e.join(', ')));
    t.classList.remove(
      't-records__overflow-clip',
      't-records__overflow-hidden'
    ),
      t.classList.add(
        r ? 't-records__overflow-clip' : 't-records__overflow-hidden'
      );
  }
}
    ...
    o =
      e && 'edit' === e.getAttribute('data-tilda-mode')
        ? '.record[data-record-type="' +
          t +
          '"] .r:not(.t397__off, .t395__off, .t400__off) .t396__artboard, .record[data-parenttplid="' +
          t +
          '"] .r:not(.t397__off, .t395__off, .t400__off) .t396__artboard'
        : '.r[data-record-type="' +
          t +
          '"]:not(.t397__off, .t395__off, .t400__off) .t396__artboard, .r[data-parenttplid="' +
          t +
          '"]:not(.t397__off, .t395__off, .t400__off) .t396__artboard';
...
function t396__isInsideGroupWithZoom(t) {
  for (var e = t.closest('.t396__group'); e; ) {
    ...
    e = null == (r = e.parentElement) ? void 0 : r.closest('.t396__group');
  }
  return !1;
}
var t396__uniqueId__generator = function t() {
  ...
  t_zeroForms__waitForResources = function t(e) {
    try {
      return Promise.resolve(
        Promise.allSettled(window.t_zeroForms__resourcesQueue[e] || [])
      ).then(function () {});
    } catch (r) {
...
if (
  ((window.t_zeroForms__browserLang = (
    window.navigator.userLanguage || window.navigator.language
  )
    .toUpperCase()
    .slice(0, 2)),
  (window.t_zeroForms__isMobile =
    /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(
      navigator.userAgent
    )),
  (window.t_zeroForms__isSafari = /^((?!chrome|android).)*safari/i.test(
    navigator.userAgent
  )),
  ...
  null !== version &&
    (window.t_zeroForms__iOSMajorVersion = parseInt(version[1], 10));
}
  ...
  if (n && document.contains(n)) {
    ...
    t_zeroForms__waitForTN(function () {
      document.contains(n) &&
        ...
        t_zeroForms__waitForResources(t).then(function () {
          t396_elem__renderViewOneField(a ? $(n) : n, 'left'),
            t396_elem__renderViewOneField(a ? $(n) : n, 'top');
        }));
    });
  }
}
...
function t_zeroForms__renderForm(t, e, r, o) {
  if (
    ((t = t_zeroForms__getEl(t)),
    o || (o = t_zeroForms__getTildaMode()),
    r || (r = t_zeroForms__getRecID(t)),
    'string' == typeof e)
  )
    try {
      e = JSON.parse(e);
  ...
  if (
    (i || (i = 'published' !== o),
    !t.classList.contains('zero-form-rendered') || i) &&
    ('published' === o && t396_zeroForms__setBrowsersInfo(),
    (!t_zeroForms__isRecordHidden(t.closest('.r')) &&
      !t_zeroForms__isFormOutside(t)) ||
      'published' !== o)
  ) {
    if (!e) {
    ...
    var d = t_zeroForms__createForm(r, o, l, t);
    if (d) {
      _.insertAdjacentElement('beforeend', d),
        t_zeroForms__placeFormIntoColumns(t);
      var c = document.createEvent('Event');
      c.initEvent('render', !0, !0),
        t.dispatchEvent(c),
        t.classList.add('zero-form-rendered'),
        t_zeroForms__initMaskAfterRender(t),
        t_zeroForms__updateTopPosition(t);
    }
  }
}
  ...
  t_zeroForms__onRender(t, !0, function () {
    ...
    t.querySelector('.js-tilda-mask') &&
      t_zeroForms__onFuncLoad('tildaForm_initMasks', function () {
        setTimeout(function () {
          var e;
          t.querySelector('.js-tilda-mask:not([data-tilda-mask-init="1"])') &&
            tildaForm_initMasks();
        }, 500);
      });
  });
}
function t_zeroForms__prepareFormsIds() {
  try {
    if ('zero' === t_zeroForms__getTildaMode())
      return void t_zeroForm__prepareFormIds__editor();
    if (window.t_zeroForms__formIdMap) return;
    var t,
      e = t396__getZeroBlocks()
        .map(function (t) {
          var e = t.record,
            r = t.artboard,
            o = Array.from(
              e.querySelectorAll('.tn-elem[data-elem-type="form"]')
            );
          if (!o.length) return null;
          var n = r.getAttribute('data-artboard-recid'),
            i;
          return [n, t_zeroForms__prepareFormIds__buildFormsIdsMap(n, o)];
        })
        .filter(Boolean);
    window.t_zeroForms__formIdMap = Object.fromEntries(e);
  } catch (r) {
    console.error('Failed to generate form ids for zero forms', r);
  }
}
function t_zeroForms__prepareFormIds__buildFormsIdsMap(t, e) {
  return e
    .map(function (t) {
      return t.getAttribute('data-elem-id');
    })
    .filter(Boolean)
    .sort()
    .reduce(function (e, r, o) {
      return (e[r] = 0 === o ? 'form' + t : 'form' + t + '_' + r), e;
    }, {});
}
function t_zeroForm__prepareFormIds__editor() {
  var t,
    e,
    r = window.tn
      ? window.tn.artboard_id
      : null == (t = document.querySelector('.tn-artboard'))
      ? void 0
      : t.getAttribute('data-record-id'),
    o = Array.from(
      document.querySelectorAll('.tn-elem[data-elem-type="form"]')
    );
  o.length &&
    r &&
    (window.t_zeroForms__formIdMap =
      (((e = {})[r] = t_zeroForms__prepareFormIds__buildFormsIdsMap(r, o)), e));
}
function t_zeroForms__getFormId(t, e) {
  var r = 'form' + t;
  try {
    return t_zeroForms__getFormId__isOpenForRec(t)
      ? (t_zeroForms__prepareFormsIds(),
        window.t_zeroForms__formIdMap[t][e] || r)
      : r;
  } catch (o) {
    return r;
  }
}
function t_zeroForms__getFormId__isOpenForRec(t) {
  var e,
    r = { team: 1244968076, tester: 1335496281, basic: 1524873151 }[
      t396_zeroForms__getUserRole()
    ];
  return !!r && Number(t) >= r;
}
function t_zeroForms__createForm(t, e, r, o) {
  ...
  if (
    ...
    var d = t_zeroForms__getFormId(t, l);
    (s.id = d),
      (s.name = d),
      // (s.action = 'https://forms.tildacdn.com/procces/'),
      (s.method = 'POST'),
  ...
  if (
    ((n.receivers ? n.receivers.split(',') : []).forEach(function (t) {
      var e = t_zeroForms__createHiddenField(
        t,
        'formservices[]',
        'js-formaction-services'
      );
      s.insertAdjacentElement('beforeend', e);
    }),
    n.formname)
  ) {
    var c = t_zeroForms__createHiddenField(
      n.formname,
      'tildaspec-formname',
      ''
    );
  ...
  if (l) {
    var u = t_zeroForms__createHiddenField(l, 'tildaspec-elemid', '');
    s.insertAdjacentElement('beforeend', u);
  }
  var m = document.createElement('div');
  m.classList.add('js-successbox'),
    m.classList.add('t-form__successbox'),
    m.classList.add('t-text'),
    m.classList.add('t-text_sm'),
    (m.style.display = 'none'),
    (m.innerHTML = n.formmsgsuccess),
    s.insertAdjacentElement('beforeend', m);
  var p = {
    ...
    f = t_zeroForms__generateInputsBlock(t, o, r, n, p);
  s.insertAdjacentElement('beforeend', f);
  var b = n.formbottomtext && n.formbottomtext.trim(),
    g;
  if (b) {
    var v = document.createElement('div');
    (v.style.textAlign = 'center' === n.buttonalign ? 'center' : 'left'),
      (v.style.color = p.color),
      (v.style.fontWeight = p.fontWeight),
      (v.style.fontFamily = p.fontFamily),
      (v.style.marginTop = '15px'),
      (v.style.fontSize = '13px');
    var F = t_zeroForms__getBottomText(l, n, t, o, b);
    v.appendChild(F), s.insertAdjacentElement('beforeend', v);
  }
  t_zeroForms__addInlineTag({
    tag: 'style',
    id: 't-zero-form-c-styles',
    content: '.tn-atom .t-input-block {position: relative;}',
    zeroForm: o,
  }),
    'y' === n.inputsstyle2 &&
      t_zeroForms__onRender(o, !1, function () {
        'zero' === window.tildamode && (n = t_zeroForms__createFormObj(t, o)),
          t_zeroForms__animateInputs(o, n, t, l);
      });
  var h = 't-zero-form-font-family-' + t + '-' + l;
  if (n.fieldfontfamily) {
    var w = t_zeroForms__createSelector(t, l, ''),
      x = [
        'input[type="text"]',
        'input[type="tel"]',
        'input[type="url"]',
      ...
      A;
    (x = x.reduce(function (t, e, r) {
      return (
        (t += w + '.t-input-block ' + e), r !== x.length - 1 && (t += ', '), t
      );
    }, '')),
      t_zeroForms__addInlineTag({
        tag: 'style',
        id: h,
        content: (A = /var\(/.test(n.fieldfontfamily)
  ...
  if (
    ...
    var L = document.querySelectorAll(
      '[data-record-type="803"], [data-parenttplid="803"]'
    );
  ...
  var k =
      window.t_zeroForms__isMobile || 'ontouchend' in document
        ? 'orientationchange'
        : 'resize',
    S = t_zeroForms__getTildaMode(),
    I = 0;
  return (
    window.addEventListener(k, function () {
      I ||
        (I = setTimeout(function () {
          t_zeroForms__updateCurrentResolution(t, S),
            t_zeroForms__updateStylesOnResize(t, o),
            clearTimeout(I),
            (I = 0);
        }, 600));
    }),
...
function t_zeroForms__updateCurrentResolution(t, e) {
  if (
    void 0 !== window.t396_detectResolution &&
    void 0 !== window.t396_switchResolution &&
    'edit' !== e
  ) {
...
function t_zeroForms__updateStylesOnResize(t, e) {
  var r = t_zeroForms__createFormObj(t, e),
    ...
    i =
      'variation' === r.inputfontweight
        ? r.inputvariationweight
        : r.inputfontweight,
  ...
  if (
    ...
    n && n.classList.add('tn-form_horiz'),
      t_zeroForms__addResource({
        recId: t,
        id: 't-zero-form-h-styles',
        type: 'link',
        path: 'tilda-zero-form-horizontal.min.css',
      });
    var s = e.querySelector('.t-form__inputsbox');
    s && s.classList.remove('t-form__inputsbox_flex'),
      s && s.classList.remove('t-form__inputsbox_inrow');
  } else
    n &&
      (n.classList.remove('tn-form_horiz'),
      t_zeroForms__placeFormIntoColumns(e));
  ...
  if (p) {
    t_zeroForms__setBtnInlineStyles(r, p),
      t_zeroForms__generateBtnStyles(p, t, o, r, e);
    var f = p.closest('.tn-form__submit');
    f &&
      ((f.style.textAlign = r.buttonalign),
      (f.style.marginTop = r.buttonmargtop + 'px'),
      t_zeroForms__updateTopPosition(e));
  }
}
function t_zeroForms__updateTopPosition(t) {
  var e;
  void 0 !== window.t396_elem__getFieldValue &&
    void 0 !== window.t396_elem__renderViewOneField &&
    document.contains(t) &&
    'top' !== t396_elem__getFieldValue(t, 'axisy') &&
...
function t_zeroForms__createCommentField() {
  ...
  return (
    (e.type = 'text'),
    (e.name = 'form-spec-comments'),
    (e.value = 'Its good'),
    e.classList.add('js-form-spec-comments'),
    (e.tabIndex = -1),
...
function t_zeroForms__generateInputsBlock(t, e, r, o, n) {
  ...
  return (
    ...
    s.insertAdjacentElement(
      'beforeend',
      t_zeroForms__createFormButton(t, e, i, o)
    ),
    s
  );
}
function t_zeroForms__parseIntoElement(t, e, r, o, n, i) {
  var a;
  if ('hd' === r.li_type)
    return t_zeroForms__createHiddenField(r.li_value, r.li_nm, '');
  var s = document.createElement('div');
  s.classList.add('t-input-group'),
    s.classList.add('t-input-group_' + r.li_type),
    s.setAttribute('data-input-lid', r.lid),
    s.setAttribute('data-field-type', r.li_type),
    s.setAttribute('data-field-name', r.li_nm);
  var l = t396_zeroForms__getDefaultOption(r);
  l && s.setAttribute('data-default-value', l),
    t_zeroForms__setStylesForFormGroup(o, s);
  var _ =
      'variation' === o.inputfontweight
        ? o.inputvariationweight
        : o.inputfontweight,
    d =
      'variation' === o.inputelsfontweight
        ? o.inputelsvariationweight
        : o.inputelsfontweight,
    c =
      'variation' === o.inputtitlefontweight
        ? o.inputtitlevariationweight
        : o.inputtitlefontweight;
  r.li_title && t_zeroForms__generateTitle(r, n, s, c),
    r.li_subtitle && t_zeroForms__generateSubtitle(r, n, s);
  var u = t_zeroForms__initInputStyles(o, _),
    m = { fontSize: o.inputelsfontsize || '', fontWeight: d || '' },
    p = {
      name: r.li_nm,
      placeholder: r.li_ph || '',
    ...
    b;
  switch ((f.classList.add('t-input-block'), r.li_type)) {
    case 'em':
      b = t_zeroForms__createInput(r, u, p, 'email');
      break;
    case 'ph':
      (b = t_zeroForms__createPhoneInput(t, r, u, p)),
        'a' === r.li_masktype &&
          (t_zeroForms__addResource({
            recId: t,
            id: 't-zero-phonemask',
            path: 'tilda-phone-mask-1.1.min.js',
            type: 'script',
          }),
      ...
      break;
    case 'nm':
      b = t_zeroForms__createInput(r, u, p, 'name');
      break;
    case 'in':
      b = t_zeroForms__createInput(r, u, p, 'oneline');
      break;
    case 'ta':
      b = t_zeroForms__createInput(r, u, p, 'textarea');
      break;
    case 'sb':
      var g = 'y' === o.inputsstyle;
      if (
        ((b = t_zeroForms__createSelect(r, u, p, g)),
        (o.inputsstyle && o.inputelscolor) || u.color)
      ) {
        var v = document.createElement('style'),
          F = t_zeroForms__createSelector(t, i, '.t-select__wrapper:after'),
          z = o.inputsstyle ? o.inputelscolor : u.color;
        (v.textContent = F + '{border-top-color:' + z + ';}'),
          b.insertAdjacentElement('beforeend', v);
      }
      break;
    case 'rd':
      var y = 'cb' === r.li_radcb ? 'checkbox' : 'radio';
      s.setAttribute('data-field-radcb', r.li_radcb),
        (b = t_zeroForms__createRadio(r, o, p, m, y, t, i)),
        t_zeroForms__setIndicatorStyles(t, i, o.inputelscolor, y, b);
      var h = t ? '#rec' + t + ' ' : '';
      t_zeroForms__addInlineTag({
        tag: 'style',
        id: 't-zero-form-fieldset-' + t,
        content: (h += 'fieldset {padding: 0; margin: 0; border: none;}'),
        zeroForm: e,
      }),
        'checkbox' === y &&
          t_zeroForms__onRender(e, !1, function () {
            ...
            t &&
              Array.prototype.slice
                .call(t.querySelectorAll('.t-checkbox'))
                .forEach(function (t) {
                  t.addEventListener(
                    'input',
                    t_zeroForms__updateCheckboxesValues
                  );
                });
          });
      break;
    case 'ri':
      (b = t_zeroForms__createRadioImage(r, o, p)),
        s.setAttribute('data-field-radcb', r.li_radcb),
        t_zeroForms__setIndicatorStyles(t, i, o.inputelscolor, 'img-select', b),
        t_zeroForms__addResource({
          recId: t,
          id: 't-zero-img-select-styles',
          path: 'tilda-img-select-1.0.min.css',
          type: 'link',
        }),
        t_zeroForms__addResource({
          recId: t,
          id: 't-zero-img-select-script',
          path: 'tilda-img-select-1.0.min.js',
          type: 'script',
        }),
        t_zeroForms__onRender(e, !1, function () {
      ...
      break;
    case 'cb':
      (b = t_zeroForms__createCheckbox(r, m, o, p)),
        t_zeroForms__setIndicatorStyles(t, i, o.inputelscolor, 'checkbox', b);
      break;
    case 'uw':
      (b = t_zeroForms__createUploadField(t, r, p, 'uw')),
      ...
      break;
    case 'uc':
      b = t_zeroForms__createUploadField(t, r, p, 'uc');
      var w = 'UPLOADCARE_LOCALE ="' + r.li_inp + '";';
      t_zeroForms__addInlineTag({
        tag: 'script',
        id: 't-zero-uploadcare-' + i,
        content: (w += 'UPLOADCARE_TABS = "all";'),
        zeroForm: e,
      });
      break;
    case 'da':
      (b = t_zeroForms__createDateField(t, r, p, u, o)),
        t_zeroForms__onRender(e, !0, function () {
      ...
      break;
    case 'tm':
      b = t_zeroForms__createInput(r, u, p, 'time');
      break;
    case 'qn':
      (b = t_zeroForms__createQuantityField(r, u, o.inputelscolor, p)),
        e.removeEventListener('click', t_zeroForms__initQuanityClickCount),
        e.addEventListener('click', t_zeroForms__initQuanityClickCount);
      break;
    case 'rg':
      if (
        ((b = t_zeroForms__createQuantityRange(t, r, u, o, p)), o.inputelscolor)
      ) {
        var x = document.createElement('style'),
          A = t_zeroForms__createSelector(t, i, '.t-range'),
          E;
        ['::-webkit-slider-thumb', '::-moz-range-thumb', '::-ms-thumb'].forEach(
          function (t) {
            x.textContent += A + t + '{background:' + o.inputelscolor + ';}';
          }
        ),
          b.insertAdjacentElement('beforeend', x);
      }
      t_zeroForms__onRender(e, !1, function () {
      ...
      break;
    case 'ur':
      b = t_zeroForms__createInput(r, u, p, 'url');
      break;
    case 'tx':
      (b = document.createElement('div')).classList.add('t-text'),
        b.setAttribute('field', 'li_text__' + r.lid),
        (b.style.fontWeight = m.fontWeight),
        (b.style.fontSize = m.fontSize + 'px'),
        (b.style.fontFamily = n.fontFamily),
        (b.style.color = n.color),
        (b.innerHTML = r.li_text || '');
      break;
    case 'ws':
      (b = document.createElement('div')).innerHTML = '&nbsp';
      var L = 34;
      r.li_rows && (b.style.height = r.li_rows * L + 'px');
      break;
    case 'fr':
      if (
        ((b = t_zeroForms__createCalculation(t, r, u, p, n)), o.inputfrbgcolor)
      ) {
        var k = document.createElement('style'),
          S = t_zeroForms__createSelector(t, i, '.t-input-group_fr');
        (k.textContent =
          S +
          '{background-color:' +
          o.inputfrbgcolor +
  ...
  if (
    (I.classList.add('t-input-error'),
    f.insertAdjacentElement('beforeend', I),
    s.insertAdjacentElement('beforeend', f),
    'h' !== o.inputpos)
  ) {
    var j = r.li_type;
    ('em' !== j &&
      ...
      'ur' !== j &&
      'tx' !== j) ||
      t_zeroForms__setFieldsRowClasses(p, s),
      'rd' === r.li_type && t_zeroForms__setRadioRowClasses(p, f);
  }
  return s;
}
...
function t_zeroForms__setStylesForFormGroup(t, e) {
  if (e) {
    var r = 'h' === t.inputpos,
      o = '';
    r && t.inputmargright
      ? (o += 'padding-right:' + t.inputmargright + 'px;')
      : !r &&
        t.inputmargbottom &&
        (o += 'margin-bottom:' + t.inputmargbottom + 'px;'),
      o && (e.style = o);
  }
}
...
function t_zeroForms__createPhoneInput(t, e, r, o) {
  ...
  if (
    (e.li_title || e.li_subtitle
      ? (i.id = e.li_type + '-' + e.lid)
      : (i.ariaLabel = 'phone'),
    t_zeroForms__appendMainSettingToField(i, o, 'tel', ''),
    'a' === n
      ? i.classList.add('js-phonemask-input')
      : e.li_mask && i.classList.add('js-tilda-mask'),
    'a' === n)
  ) {
    var a = 'RU' === window.t_zeroForms__browserLang ? '+7' : '+1';
    (i.placeholder = a + '(000)000-0000'),
      i.setAttribute('data-phonemask-init', 'no'),
      i.setAttribute('data-phonemask-id', t),
      i.setAttribute('data-phonemask-lid', e.lid),
      e.li_maskcountry &&
        i.setAttribute('data-phonemask-maskcountry', e.li_maskcountry),
      o.secondaryClassName && i.classList.add(o.secondaryClassName),
      o.require && i.setAttribute('data-tilda-req', '1');
  } else
    t_zeroForms__appendAttributes(i, o),
      i.setAttribute('data-tilda-rule', 'phone'),
      o.mask && i.setAttribute('data-tilda-mask', o.mask);
...
function t_zeroForms__createInput(t, e, r, o) {
  var n = document.createElement('textarea' === o ? 'textarea' : 'input'),
    ...
    a,
    s;
  (t.li_title || t.li_subtitle
    ? (n.id = t.li_type + '-' + t.lid)
    : (n.ariaLabel = o),
  ...
  'time' === o &&
    (n.setAttribute('data-tilda-mask', '99:99'),
    n.classList.add('t-inputtime')),
  ('time' === o || ('oneline' === o && t.li_mask)) &&
    n.classList.add('js-tilda-mask'),
  'oneline' === o &&
    (r.rule && n.setAttribute('data-tilda-rule', r.rule),
    r.mask && n.setAttribute('data-tilda-mask', r.mask)),
  t_zeroForms__appendAttributes(n, r),
  t_zeroForms__appendStylesToField(n, e),
  'textarea' === o) &&
    (t_zeroForms__addInlineTag({
      tag: 'style',
      id: 'zero-forms-textarea-styles',
      content:
        '.t396__elem .t-input-group_ta textarea.t-input {padding-top:10px; vertical-align: bottom; resize: none;}',
      zeroForm: null,
    }),
    t_zeroForms__setTextareaHeight(t, n));
  return n;
}
function t_zeroForms__setTextareaHeight(t, e) {
  var r = 25,
    o = 10;
  t.li_rows > 1 &&
    ((e.style.height = t.li_rows * r + o + 'px'),
    e.setAttribute('data-rows', t.li_rows)),
    (e.rows = parseInt(t.li_rows, 10) || 3);
}
function t_zeroForms__createSelect(t, e, r, o) {
  var n = t.li_variants ? t.li_variants.split('\n') : [],
    i = parseInt(t.li_defselitem, 10),
    a = document.createElement('div');
  a.classList.add('t-select__wrapper'),
    r.secondaryClassName && a.classList.add('t-select__wrapper_bbonly');
  ...
  if (t.li_selfirstvar) {
    ...
    (_.textContent = t.li_selfirstvar),
      _.setAttribute('value', ''),
      l && (_.style.color = e.color),
  ...
  return (
    n.forEach(function (r, o) {
      var n = document.createElement('option'),
        ...
        _ = a.label,
        d = a.calcValue;
      d && t396_zeroForms__setCalcValue(n, d),
        (n.value = _),
        (n.textContent = _),
        l && (n.style.color = e.color),
        i && i === o + 1 && (n.selected = !0),
...
function t_zeroForms__createRadio(t, e, r, o, n, i, a) {
  ...
  l &&
    t.li_ownvariant &&
    t.li_ownvariant.trim() &&
    s.push(t.li_ownvariant.trim());
  var _ = 'cb' === t.li_radcb,
    d = parseInt(t.li_defselitem, 10),
    c = document.createDocumentFragment(),
    u,
    m = t_zeroForms__createWrapper(
      (_ ? 't-checkboxes' : 't-radio') + '__wrapper'
    );
  _ &&
    c.appendChild(t_zeroForms__createNameFieldForCheckbox(r, m, 'checkboxes')),
    c.appendChild(m);
  ...
  return (
    s.forEach(function (s, l) {
      ...
      var b = t396_zeroForms__prepareCalcValue(t, s),
        g = b.label,
        v = b.calcValue;
      v && t396_zeroForms__setCalcValue(m, v),
        (m.value = g),
        m.classList.add('t-' + n),
        _ || m.classList.add('js-tilda-rule'),
        _ || (m.name = r.name);
      var F = t.li_title || t.li_subtitle;
      if ((!_ && F && (m.ariaLabel = F), d && d === l + 1)) {
        m.checked = !0;
        var z = c.querySelector('.t-checkboxes__hiddeninput');
        z && (z.value = m.value);
      }
      r.require && m.setAttribute('data-tilda-req', '1'),
        f.push(m),
        u.insertAdjacentElement('beforeend', m);
      var y = t_zeroForms__createIndicator(n, e.inputelscolor, !1);
      u.insertAdjacentElement('beforeend', y);
...
function t_zeroForms__createStyleObjectForOwnAnswer(t, e) {
  ...
  return (
    r && r.fontSize && (r.fontSize += 'px'),
    e.inputfontfamily && (r.fontFamily = e.inputfontfamily),
    e.inputtitlecolor &&
      ((r.color = e.inputtitlecolor), (r.borderColor = e.inputtitlecolor)),
    r
  );
}
function t_zeroForms__createOwnAnswer(t, e, r, o, n, i, a) {
  ...
  var s = document.createElement('div');
  s.classList.add('t-input__own-answer-wrapper'),
    'checkbox' === t.type &&
      s.classList.add('t-input__own-answer-wrapper-checkbox');
  var l = t_zeroForms__createOwnAnswerInput(r, o, n, t.checked);
  return (
    t_zeroForms__processOwnAnswerPlaceholder(r.li_ownvariantph, l, o, i, a, t),
    s.insertAdjacentElement('beforeend', e),
    s.insertAdjacentElement('beforeend', l),
    t_zeroForms__setListenersForOwnAnswer(t, l),
    s
  );
}
function t_zeroForms__processOwnAnswerPlaceholder(t, e, r, o, n, i) {
  if (t && ((e.placeholder = t), r.color)) {
    var a = document.createElement('style'),
      s = t_zeroForms__createSelector(
        o,
        n,
        '.t-input__own-answer::placeholder'
      );
    (a.textContent = s + '{color:' + r.color + ';}'),
...
function t_zeroForms__setListenersForOwnAnswer(t, e) {
  e.addEventListener('blur', function (r) {
    ...
    o && (n += ': ' + o),
      (t.value = n),
      'checkbox' === t.type && t_zeroForms__updateCheckboxesValues(r);
  });
}
function t_zeroForms__createOwnAnswerInput(t, e, r, o) {
  var n = t_zeroForms__createInput(t, e, r, 'oneline');
  n.classList.add('t-input__own-answer'),
    n.classList.add('t-input_bbonly'),
    n.removeAttribute('data-tilda-req'),
    n.removeAttribute('name');
  var i = t_zeroForms__getTildaMode();
  return (
    (o || 'zero' === i) && n.classList.add('t-input__own-answer--active'), n
  );
}
  ...
  t.forEach(function (t) {
    t.addEventListener('change', function () {
      ...
      if (r && o) {
        var n = o.checked,
          i = n ? 'add' : 'remove';
        r.classList[i]('t-input__own-answer--active'),
          n && t === o && r.focus();
      }
    });
  });
...
function t_zeroForms__createRadioImage(t, e, r) {
  ...
  if (t.li_gallery)
    try {
      n =
        'string' == typeof t.li_gallery
          ? JSON.parse(t.li_gallery)
          : t.li_gallery;
    } catch (u) {}
  if (n) {
    ...
    t.li_imgs_in_row_mob
      ? l.classList.add(
          't-img-select__container__mobile_' + t.li_imgs_in_row_mob + '-in-row'
        )
      : e.shouldUseTwoColumnRadioImg &&
        l.classList.add('t-img-select__container__mobile_2-in-row'),
      t.li_imgs_in_row &&
        l.classList.add(
          't-img-select__container_' + t.li_imgs_in_row + '-in-row'
        ),
      l.setAttribute('data-check-bgcolor', e.inputelscolor || '#000'),
      o &&
        s.appendChild(
          t_zeroForms__createNameFieldForCheckbox(r, l, 'img-select')
        ),
      s.appendChild(l);
    var _ = o ? 'checkbox' : 'radio',
      d,
      c =
        't-img-select__indicator_' +
        (t.li_imgratio ? t.li_imgratio.replace('_', '-') : '1-1');
    return (
      i.forEach(function (n, i) {
        var s = t_zeroForms__createLabel('img-select', '', !1),
          ...
          m = u.label,
          p = u.calcValue;
        p && t396_zeroForms__setCalcValue(d, p),
          (d.type = _),
          (d.value = m || n.img),
          d.classList.add('t-img-select'),
          o || (d.name = t.li_nm),
          o || d.classList.add('js-tilda-rule'),
          a && a === i + 1 && (d.checked = !0),
          r.require && d.setAttribute('data-tilda-req', '1'),
        ...
        if (
          ...
          t.li_img_fill_mode &&
            f.classList.add(
              't-img-select__indicator_fillmode-' + t.li_img_fill_mode
            ),
          e.inputtitlecolor &&
            (f.style.borderColor = t_zeroForms__fromHEXtoRGBA(
              e.inputtitlecolor,
              0.1
            )),
          f.classList.add(c),
          ...
          b.classList.add('t-img-select__text'),
            b.classList.add('t-text'),
            b.classList.add('t-text_xs'),
            (b.textContent = m),
            e.inputtitlecolor && (b.style.color = e.inputtitlecolor),
...
function t_zeroForms__createCheckbox(t, e, r, o) {
  ...
  t_zeroForms__appendMainSettingToField(i, o, 'checkbox', 't-checkbox'),
    (i.value = 'yes'),
    t.li_checked && (i.checked = !0),
    o.require && i.setAttribute('data-tilda-req', '1'),
  ...
  var l = t396_zeroForms__prepareCalcValue(t, t.li_label),
    ...
    d = l.calcValue;
  return (
    d && t396_zeroForms__setCalcValue(i, d),
    (s.innerHTML = _),
    n.insertAdjacentElement('beforeend', s),
    n
  );
}
function t_zeroForms__createUploadField(t, e, r, o) {
  var n = 'uw' === o;
  if ('published' !== window.tildamode) {
    var i =
        'color:#fff;background-color:#000; padding:10px 20px; display:inline-block;',
      a = document.createElement('div');
    a.setAttribute('style', i);
    var s = n && '' === e.li_uwkey;
    return (
      (a.textContent = s ? 'Please set the key' : 'Upload button will be here'),
      a
    );
  }
  var l = n ? 't-upwidget' : 't-uploadcare',
    _ = t_zeroForms__createWrapper(l),
    d = n ? 'margin-bottom:5px;min-height:38px;' : 'margin-bottom:10px;';
  _.setAttribute('style', d);
  var c = document.createElement('input');
  t_zeroForms__appendMainSettingToField(c, r, 'hidden', ''),
    c.setAttribute('role', n ? 'upwidget-uploader' : 'uploadcare-uploader'),
    r.require && c.setAttribute('data-tilda-req', '1'),
    (c.style.display = 'none'),
    n
      ? (c.setAttribute('data-tilda-upwidget-key', e.li_uwkey || ''),
        'y' === e.li_multiupl &&
          c.setAttribute('data-tilda-upwidget-multiple', '1'))
      : c.setAttribute('data-public-key', e.li_uckey || 'demopublickey'),
    _.insertAdjacentElement('beforeend', c);
  var u = n ? 'tilda-upwidget-1.1.min.js' : 'uploadcare-3.x.min.js';
  return (
    'uploadcare-3.x.min.js' !== u ||
      window.jQuery ||
      (u = 'uploadcare-3.x.full.min.js'),
    (n || (!n && !document.querySelector('script[src*="uploadcare-3.x"]'))) &&
      t_zeroForms__addResource({
        recId: t,
        id: l + '-zero-form',
        path: u,
...
function t_zeroForms__createDateField(t, e, r, o, n) {
  var i = t_zeroForms__createWrapper('t-datepicker__wrapper'),
  ...
  s.length && ',' === s[s.length - 1] && (s = s.slice(0, -1)),
    t_zeroForms__appendMainSettingToField(a, r, 'text', [
      't-input',
      't-datepicker',
      'js-tilda-mask',
    ]),
    t_zeroForms__appendAttributes(a, r),
    t_zeroForms__appendStylesToField(a, o),
    a.setAttribute('data-tilda-rule', 'date'),
    a.setAttribute('data-tilda-dateformat', e.li_dateformat),
    a.setAttribute('data-tilda-datediv', e.li_datediv),
    a.setAttribute('data-tilda-mask', e.li_datemask),
    a.setAttribute('data-tilda-dateunvailable', s),
    (a.id = e.li_type + '-' + e.lid),
    i.insertAdjacentElement('beforeend', a);
  var l,
    _ =
      '<svg class="t-datepicker__icon" fill="' +
      (n.inputsstyle ? n.inputelscolor : o.color) +
  ...
  return (
    ...
    t_zeroForms__addResource({
      recId: t,
      id: 't-zero-date-styles',
      path: 'tilda-date-picker-1.0.min.css',
      type: 'link',
    }),
    t_zeroForms__addResource({
      recId: t,
      id: 't-zero-date-script',
      path: 'tilda-date-picker-1.0.min.js',
      type: 'script',
    }),
    i
  );
...
function t_zeroForms__createQuantityField(t, e, r, o) {
  ...
  return (
    t_zeroForms__appendMainSettingToField(s, o, 'number', [
      't-input',
      't-inputquantity',
    ]),
...
function t_zeroForms__createQuantityBtn(t, e) {
  ...
  return (
    ...
    r.classList.add('t-inputquantity__btn-' + t),
    e && (r.style.color = e),
    (r.innerHTML = 'minus' === t ? '&ndash;' : '+'),
    r
  );
}
...
function t_zeroForms__createQuantityRange(t, e, r, o, n) {
  var i = t_zeroForms__createWrapper('t-range__wrapper'),
    a = document.createElement('input');
  t_zeroForms__appendMainSettingToField(a, n, 'range', 't-range'),
    o.inputelscolor && a.setAttribute('data-range-color', o.inputelscolor),
    (a.min = t_zeroForms__validateNumericValue(e.li_vmin, '0')),
    (a.max = t_zeroForms__validateNumericValue(e.li_vmax, '10')),
    (a.step = t_zeroForms__validateNumericValue(e.li_step, '1')),
    (a.value = t_zeroForms__validateNumericValue(e.li_value)),
    (a.style.width = '100%'),
    e.li_title || e.li_subtitle
      ? (a.id = e.li_type + '-' + e.lid)
      : (a.ariaLabel = 'range'),
    i.insertAdjacentElement('beforeend', a);
  var s = document.createElement('div');
  s.classList.add('t-range__value-txt'),
    s.classList.add('t-descr'),
    s.classList.add('t-descr_xxs'),
    (s.style.display = 'none'),
    i.insertAdjacentElement('beforeend', s);
  var l = document.createElement('div');
  l.classList.add('t-range__interval-txt-wrapper');
  var _ = t_zeroForms__createRangeField(
      'min',
      o.inputtitlecolor,
      e.li_vmin || '0'
    ),
    d = t_zeroForms__createRangeField(
      'max',
      o.inputtitlecolor,
      e.li_vmax || '10'
    );
  return (
    ...
    t_zeroForms__addResource({
      recId: t,
      id: 't-zero-range-script',
      path: 'tilda-range-1.0.min.js',
      type: 'script',
    }),
    t_zeroForms__addResource({
      recId: t,
      id: 't-zero-range-styles',
      path: 'tilda-range-1.0.min.css',
      type: 'link',
    }),
    i
  );
...
function t_zeroForms__createRangeField(t, e, r) {
  ...
  return (
    o.classList.add('t-range__interval-txt'),
    o.classList.add('t-range__interval-txt_' + t),
...
function t_zeroForms__createCalculation(t, e, r, o, n) {
  var i = document.createDocumentFragment(),
    a = document.createElement('input');
  t_zeroForms__appendMainSettingToField(a, o, 'hidden', 't-calc__hiddeninput'),
    (a.tabIndex = -1),
    (a.value = '0'),
    i.appendChild(a);
  var s = t_zeroForms__createWrapper([
    't-calc__wrapper',
    't-name',
    't-name_md',
  ]);
  (s.style.color = r.color),
    (s.style.fontFamily = n.fontFamily),
    (s.style.fontSize = r.fontSize),
    (s.style.fontWeight = r.fontWeight),
    t_zeroForms__createCalcTextField(e.li_prefix, 'prefix', s);
  var l = document.createElement('span');
  if (
    (l.classList.add('t-calc'),
    l.setAttribute(
      'data-calc-expr',
      t_zeroForms__removeStringQuotes(e.li_expr)
    ),
    (l.textContent = '0'),
    s.insertAdjacentElement('beforeend', l),
    t_zeroForms__createCalcTextField(e.li_postfix, 'postfix', s),
    t_zeroForms__addResource({
      recId: t,
      id: 't-zero-calc',
      path: 'tilda-calc-1.0.min.js',
      type: 'script',
    }),
    i.appendChild(s),
    'y' !== e.li_addtocart)
    ...
    return i;
  if (e.li_prod_title) {
    var _ = t_zeroForms__createHiddenField(
      e.li_prod_title,
      'prod_title',
  ...
  if (e.li_prod_img) {
    var d = t_zeroForms__createHiddenField(
      e.li_prod_img,
      'prod_img',
      't-calc__hidden__prod_img'
    );
    s.insertAdjacentElement('beforeend', d);
  }
  if (e.li_prod_options) {
    var c = t_zeroForms__createHiddenField(
      e.li_prod_options,
      'prod_options',
      't-calc__hidden__prod_options'
    );
    s.insertAdjacentElement('beforeend', c);
  }
  return i;
...
function t_zeroForms__createCalcTextField(t, e, r) {
  if (t) {
    ...
    o.classList.add('t-calc__' + e + '-text'),
      (o.textContent = t),
...
function t_zeroForms__createFormButton(t, e, r, o) {
  ...
  n.classList.add('tn-form__submit'),
    (n.style.textAlign = o.buttonalign),
    (n.style.marginTop = o.buttonmargtop + 'px');
  var i = document.createElement('button');
  (i.type = 'submit'),
    i.classList.add('t-submit'),
    (i.style.padding = '0 15px'),
...
function t_zeroForms__setBtnInlineStyles(t, e) {
  ...
  (e.style.width = t.buttonwidth ? t.buttonwidth + 'px' : '100%'),
    ...
    (t.buttonshadowsize || t.buttonshadowopacity) &&
      (e.style.boxShadow =
        '0px 0px ' +
        (t.buttonshadowsize ? t.buttonshadowsize + 'px' : '10px') +
        ' 0px rgba(0, 0, 0, ' +
        (t.buttonshadowopacity ? t.buttonshadowopacity / 100 : '0.3') +
        ')');
}
function t_zeroForms__generateBtnStyles(t, e, r, o, n) {
  var i,
    a = t_zeroForms__generateButtonStyles(
      o,
      window.getComputedStyle(t).fontFamily
    ),
    s = t_zeroForms__generateButtonHoverStyles(o),
    l =
      document.getElementById('t-uploadcare-zero-form') ||
      document.querySelector('script[src*="uploadcare-3.x"]'),
    _ = document.getElementById('t-upwidget-zero-form'),
    d = t_zeroForms__createSelector(e, r, ''),
    c = d + '.t-submit',
    u = t_zeroForms__getGradientBGStyles(o, c);
  l &&
    ((c += ', '),
    (c +=
      d + '.uploadcare--widget__button.uploadcare--widget__button_type_open')),
    _ && ((c += ', '), (c += d + '.t-upwidget-container__button'));
  var m,
    p = c + '{' + a + (s ? 'transition: 0.3s ease all;' : '') + '}';
  u &&
    ((p += u),
    ...
    _ &&
      ((p += d + '.t-upwidget-container__button '),
      (p +=
        '{background-image: ' +
        o.buttonbgcolor +
        '; background-color: transparent;}')));
  ...
  if (
    ...
    t_zeroForms__addInlineTag({ tag: 'style', id: f, content: p, zeroForm: n }),
    s)
  ) {
    var g = c.split(', ').map(function (t) {
        return t + ':hover';
      }),
      v = (g = g.join(', ')) + '{' + s + '}',
      F = 't-zero-form-btn-hover-styles-' + r + '-' + e,
      z = document.getElementById(F);
    z && z.parentElement && z.parentElement.removeChild(z),
      t_zeroForms__addInlineTag({
        tag: 'style',
        id: F,
        content: v,
...
function t_zeroForms__generateButtonStyles(t, e) {
  var r = {
      ...
      border: t.buttonbordersize
        ? t.buttonbordersize +
          'px solid ' +
          (t.buttonbordercolor || 'transparent')
        : '',
...
function t_zeroForms__processButtonBG(t, e) {
  ...
  return r.buttonBGHasGradient || r.buttonHoverBGHasGradient
    ? ''
    : o
    ? 'background-color: ' + o + ';'
    : e
...
function t_zeroForms__getGradientBGStyles(t, e) {
  ...
  var s = '';
  return (
    (s += e + '.tn-form__submit-gradient::before {'),
    (s += t_zeroForms__generateButtonBGStyle(i, o)),
    (s += '}'),
    (s += e + '.tn-form__submit-gradient::after {'),
    (s += t_zeroForms__generateButtonBGStyle(a, n)),
    (s += '}')
  );
}
function t_zeroForms__generateButtonBGStyle(t, e) {
  return (
    t || (t = e ? 'none' : 'transparent'),
    e ? 'background-image: ' + t + ';' : 'background-color: ' + t + ';'
  );
}
function t_zeroForms__generateButtonHoverStyles(t) {
  if (
    !(
      t.buttonhovercolor ||
      t.buttonhoverbordercolor ||
      t.buttonhoverbgcolor ||
      t.buttonhovershadowsize
    )
  )
    return '';
  var e = {
  ...
  (t.buttonhovershadowsize || t.buttonshadowopacity) &&
    (e['box-shadow'] =
      '0px 0px ' +
      (t.buttonhovershadowsize ? t.buttonhovershadowsize + 'px' : '10px') +
      ' 0px rgba(0, 0, 0, ' +
      (t.buttonshadowopacity ? t.buttonshadowopacity / 100 : '0.3') +
      ')');
  var r = '';
...
function t_zeroForms__getBottomText(t, e, r, o, n) {
  ...
  if (
    ...
    s.classList.add('t-text'),
      s.classList.add('t-text_xxs'),
      e.inputtitlecolor && (s.style.color = e.inputtitlecolor);
    var l = document.createElement('input'),
      _;
    t_zeroForms__appendMainSettingToField(
      l,
      { name: 'form_bottom_checkbox' },
      'checkbox',
      't-checkbox'
    ),
      l.setAttribute('data-tilda-req', '1'),
      'cbx' === e.formbottomcb && (l.checked = !0),
      s.insertAdjacentElement('beforeend', l);
    var d = t_zeroForms__createIndicator('checkbox', e.inputelscolor, !1);
    (d.style.width = '15px'),
      (d.style.height = '15px'),
      (d.style.marginRight = '5px'),
      s.insertAdjacentElement('beforeend', d);
    var c = document.createElement('span');
    c.classList.add('t-checkbox__labeltext'),
      (c.innerHTML = n),
      s.insertAdjacentElement('beforeend', c);
    var u = t_zeroForms__createSelector(
        r,
        t,
    ...
    return (
      t_zeroForms__addInlineTag({
        tag: 'style',
        id: 't-zero-form-btn-styles-' + t,
        content: u + '{' + (m += 'left:3px;top:0;height:6px;') + '}',
        zeroForm: o,
      }),
      s
    );
...
function t_zeroForms__animateInputs(t, e, r, o) {
  ...
  if (e.inputcolor) {
    var i,
      a = [
        '.t-input-group:not(.t-input-group_da):not(.t-input-group_ph):not(.t-input-group_uw):not(.t-input-group_ri):not(.t-input-group_cb):not(.t-input-group_rg) .t-input',
    ...
    t_zeroForms__addInlineTag({
      tag: 'style',
      id: 't-zero-form-anim-styles-' + r + '-' + o,
      content: (a += '{ color: ' + e.inputcolor + '; }'),
      zeroForm: t,
    });
  }
  var s = (Number(e.inputheight) - Number(e.inputfontsize)) / 2,
    l =
      'variation' === e.inputfontweight
        ? e.inputvariationweight
        : e.inputfontweight,
    _ =
      n +
  ...
  if (
    (Array.prototype.slice
      .call(document.querySelectorAll(_))
      .forEach(function (t) {
        ...
        if (r) {
          ...
          o.classList.add('t-input__vis-ph'),
            s && (o.style.top = s + 'px'),
            l && (o.style.fontWeight = l),
            e.inputfontsize &&
              ((o.style.fontSize = e.inputfontsize + 'px'),
              (o.style.height = parseInt(e.inputfontsize, 10) + 1 + 'px')),
            (o.textContent = r),
    ...
    var c = t.querySelectorAll('textarea:not(.t-input_bbonly)'),
      u = t.querySelectorAll('textarea.t-input_bbonly');
...
function t_zeroForms__appendAttributes(t, e) {
  e.secondaryClassName && t.classList.add(e.secondaryClassName),
    e.placeholder && (t.placeholder = e.placeholder),
    e.require && t.setAttribute('data-tilda-req', '1');
}
function t_zeroForms__appendStylesToField(t, e) {
  for (var r in (t.classList.contains('t-input-inline-styles') ||
    t.classList.add('t-input-inline-styles'),
  e))
    t.style[r] = e[r];
  if (t.classList.contains('t-input-phonemask__wrap')) {
    var o = t.querySelector('.t-input-phonemask__select-code');
    o && (o.style.fontSize = e.fontSize),
      o && (o.style.fontWeight = e.fontWeight);
    var n = t.querySelector('.t-input-phonemask');
    n && (n.style.fontSize = e.fontSize),
      n && (n.style.fontWeight = e.fontWeight);
  }
}
...
function t_zeroForms__createInputPlaceholderStyles(t, e, r, o) {
  ...
  i.forEach(function (t) {
    ...
    t_zeroForms__addInlineTag({
      tag: 'style',
      id: 't-zero-placeholder-' + r + '-' + t,
      content: s,
      zeroForm: o,
    });
}
function t_zeroForms__addResource(t) {
  var e = t || {},
    r = e.id,
    o = e.path,
    n = e.type,
  ...
  if (!document.getElementById(r)) {
    t_zeroForms__isInWhiteList(o);
    var a = document.getElementById('allrecords'),
      s = a && 'yes' === a.getAttribute('data-tilda-export'),
      l = document.querySelector('script[src*="tilda-zero-forms"]'),
      _ = l ? l.src : '',
      d = 'https://static.tildacdn.' + t_zeroForms__getRootZone();
    !s && _ && -1 !== _.indexOf('https://') && (d = _.split('/js/')[0]);
    var c = document.createElement(n);
    (c.id = r),
      'script' === n
        ? ((c.src = d + '/js/' + o), (c.async = !0))
      ...
      t_zeroForms__addResourceToQueue(i, c),
      document.head.insertAdjacentElement('beforeend', c);
  }
}
function t_zeroForms__addInlineTag(t) {
  var e = t || {},
    r = e.id,
    o = e.content,
    n = e.zeroForm,
    i = e.tag;
  if (!document.getElementById(r) && o) {
    var a = document.createElement(i),
      s;
    (a.id = r),
      (a.textContent = o),
      (n ? n.querySelector('.tn-atom') : document.head).insertAdjacentElement(
        'beforeend',
        a
      );
  }
...
function t_zeroForms__isInWhiteList(t) {
  ...
  if (
    ...
    ![
      ...
      'tilda-zero-form-horizontal.min.css',
      'tilda-phone-mask-1.1.min.js',
      'tilda-date-picker-1.0.min.css',
      'tilda-date-picker-1.0.min.js',
      'tilda-calc-1.0.min.js',
      'tilda-upwidget-1.1.min.js',
      'uploadcare-3.x.full.min.js',
      'uploadcare-3.x.min.js',
      'tilda-range-1.0.min.js',
      'tilda-range-1.0.min.css',
...
function t_zeroForms__createLabel(t, e, r) {
  ...
  return (
    ...
    r &&
      r.inputfontfamily &&
      ((o.style.fontFamily = r.inputfontfamily),
      o.style.fontFamily ||
        (o.style.fontFamily = '"' + r.inputfontfamily + '"')),
    o
  );
...
function t_zeroForms__createIndicator(t, e, r) {
  var o = document.createElement('div');
  return (
    o.classList.add('t-' + t + '__indicator'),
    e && (o.style.borderColor = e),
    'img-select' === t &&
      (o.classList.add('t-bgimg'),
      o.classList.add(r.ratio),
      o.setAttribute('data-original', r.img),
      (o.style.backgroundImage = r.img)),
    o
  );
}
function t_zeroForms__createNameFieldForCheckbox(t, e, r) {
  ...
  return (
    ...
    (o.tabIndex = -1),
    t.require && o.setAttribute('data-tilda-req', '1'),
    o
  );
}
...
function t_zeroForms__initInputStyles(t, e) {
  var r = {
      color: t.inputcolor || '',
      border: t.inputbordersize
        ? t.inputbordersize + 'px solid ' + (t.inputbordercolor || '#000')
        : '',
...
function t_zeroForms__isFormOutside(t) {
  ...
  var c = t396_zeroForms__getScaleFactor(t),
    u = t_zeroForms__setScaleFactor(s.left, c),
    m = t_zeroForms__setScaleFactor(parseInt(t.style.top, 10), c) || 0;
  m < 0 && m > -50 && (m = 0);
  ...
  return e && window.tn['ab' + e]
    ? {
        res: window.t396_detectResolution
          ? t396_detectResolution(e)
          : window.tn['ab' + e].curResolution,
...
function t_zeroForms__getRecID(t) {
  ...
  return e
    ? e.getAttribute('data-artboard-recid') || e.getAttribute('data-record-id')
    : '';
}
function t_zeroForms__createSelector(t, e, r) {
  var o;
  return (
    ('zero' === window.tildamode
      ? '[data-record-id="' + t + '"]'
      : '#rec' + t) +
    ' [data-elem-id="' +
    e +
...
function t_zeroForms__initQuanityClickCount(t) {
  ...
  if (e) {
    ...
    i.initEvent('input', !0, !0),
      n
        ? o.value > 0 && ((o.value = Number(o.value) - 1), o.dispatchEvent(i))
        : o.value >= 0 && ((o.value = Number(o.value) + 1), o.dispatchEvent(i));
  }
}
...
function t_zeroForms__onRender(t, e, r) {
  (('edit' !== window.tildamode && 'zero' !== window.tildamode) || !e) &&
    t_zeroForms__onReady(function () {
      t.classList.contains('zero-form-rendered')
        ? r()
        : t.addEventListener('render', r);
    });
}
...
function t_zeroForms__moveFieldToNextRow(t) {
  var e;
  t_zeroForms__createArrWithAllRows(t, 't-input-group_inrow').forEach(function (
    t
  ) {
    var e = !1;
    if (
...
function t_zeroForms__combineFieldsWithDefWidth(t) {
  var e = [],
    r;
  t_zeroForms__createArrWithAllRows(t, 't-input-group_widthdef').forEach(
    function (t) {
      var r = 4;
      if (t.length > 4)
...
function t_zeroForms__setFieldsRowClasses(t, e) {
  ...
  void 0 !== t.inputInRow &&
    ...
    e.classList.add('t-input-group_inrow-withsibling'),
    t.inputWidth || e.classList.add('t-input-group_widthdef'));
}
function t_zeroForms__setRadioRowClasses(t, e) {
  ...
  void 0 === i ||
    'y' !== i ||
    ('1_2' !== r && '1_3' !== r && '1_4' !== r) ||
    e.classList.add('t-input-block_rd-mobile-half');
}
...
function t396_zeroForms__getScaleFactor(t) {
  ...
  var r = e.getAttribute('data-artboard-recid'),
    o;
  return (
    (r && window.tn['ab' + r] && window.tn['ab' + r].scaleFactor) ||
...
function t396_zeroForms__setBrowsersInfo() {
  if (void 0 === window.isOnlyScalable) {
    ...
    (window.isOnlyScalable = e < 126),
      (window.shouldUseScaleFactor = !window.isOnlyScalable && !t && o <= 127);
  }
}
...
function t396_zeroForms__getDefaultOption(t) {
  return t
    ? ['sb', 'ri', 'rd'].includes(t.li_type)
      ? t.li_defselitem || null
      : ['cb'].includes(t.li_type)
      ? t.li_checked || null
      : ['qn', 'rg'].includes(t.li_type)
      ? t.li_value || null
      : void 0
    : null;
}
function t396_zeroForms__getProjectId() {
  return 'zero' === t_zeroForms__getTildaMode()
    ? window.projectid
    : document
        .getElementById('allrecords')
        .getAttribute('data-tilda-project-id');
  var t, e;
}
function t396_zeroForms__getUserRole() {
  if ('published' !== t_zeroForms__getTildaMode()) {
    var t = 'basic';
    return (
      '99' === window.$oplan ? (t = 'team') : window.userrole && (t = 'tester'),
      t
    );
  }
  var e = document.getElementById('allrecords');
  if (!e) return 'basic';
  var r = 'y' === e.getAttribute('data-tilda-ts'),
    o,
    n = 'basic';
  return (
    'y' === e.getAttribute('data-tilda-te')
      ? (n = 'team')
      : r && (n = 'tester'),
    n
  );
}
function t_zeroForms__addResourceToQueue(t, e) {
  var r = 5e3;
  (window.t_zeroForms__resourcesQueue[t] =
    window.t_zeroForms__resourcesQueue[t] || []),
    window.t_zeroForms__resourcesQueue[t].push(
      new Promise(function (t, o) {
        if ('true' !== e.getAttribute('data-loaded')) {
...
(window.t_zeroForms__formIdMap = null),
  (window.t_zeroForms__resourcesQueue = {}),
  t_zeroForms__onReady(function () {
    var t = document.getElementById('allrecords');
    if (t) {
  ...
  t_zeroForms__onReady(t_zeroForms__prepareFormsIds);
